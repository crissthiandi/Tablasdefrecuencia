...
Pregunta 46.5
```{r}
imprime=tabla(columna = 91,si=4,no=c(1,2,3,999),nose = NULL)
imprime
inter=tabla(columna = 171,si=4,no=c(1,2,3,999),nose = NULL)
inter
final=tabla(columna = 250,si=4,no=c(1,2,3,999),nose = NULL)
final
tabla19sub=subset(cbind(imprime,inter,final),select = c(1,2,3,5,6,8,9))
tabla19=rbind(tabla19,tabla19sub)
```
...
Pregunta 47
```{r}
imprime=tabla(columna = 93)
imprime
inter=tabla(columna = 173)
inter
final=tabla(columna = 252)
final
...
pregunta 48
```{r}
imprime=tabla(columna = 94)
imprime
inter=tabla(columna = 174)
inter
final=tabla(columna = 253)
final
tabla20sub=subset(cbind(imprime,inter,final),select = c(1,2,3,5,6,8,9))
tabla20=rbind(tabla19,tabla19sub)
```
...
pregunta 33
```{r}
imprime=tabla(columna = 59,si=2, no=c(3,4,1))
imprime
inter=tabla(columna = 137,si=2, no=c(3,4,1))
inter
final=tabla(columna = 214,si=2, no=c(3,4,1))
final
tabla20sub=subset(cbind(imprime,inter,final),select = c(1,2,3,5,6,8,9))
tabla20=rbind(tabla20,tabla20sub)
```
...
pregunta 34
```{r}
imprime=tabla(columna = 60,si=1,titulo_si = "Han aumentado", no=2, titulo_no = "Han disminuido",nose=3,titulo_nose = "Esta igual", otros = c(4,777),titulos_otros = c("Han aumentado pero no pican","No sabe"))
imprime
inter=tabla(columna = 138,si=1,titulo_si = "Han aumentado", no=2, titulo_no = "Han disminuido",nose=3,titulo_nose = "Esta igual", otros = c(4,777),titulos_otros = c("Han aumentado pero no pican","No sabe"))
inter
final=tabla(columna = 215,si=1,titulo_si = "Han aumentado", no=2, titulo_no = "Han disminuido",nose=3,titulo_nose = "Esta igual", otros = c(4,777),titulos_otros = c("Han aumentado pero no pican","No sabe"))
final
tabla20sub=subset(cbind(imprime,inter,final),select = c(1,2,3,5,6,8,9))
tabla20=rbind(tabla20,tabla20sub)
```
