...
Pregunta 36.5 + 36.2
```{r warning=FALSE}
imprime1=tabla(columna = 69)
inter1=tabla(columna = 147)
final1=tabla(columna = 225)

imprime2=tabla(columna = 72)
imprime=imprime2+imprime1
imprime$estatus=c("Si","No")

inter2=tabla(columna = 150)
inter=inter2+inter1
inter$estatus=c("Si","No")

final2=tabla(columna = 228)
final=final2+final1
final$estatus=c("Si","No")
